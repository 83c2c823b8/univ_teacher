  ...
  \begin{center}
    \scalebox{0.8}[0.8]{
      \begin{tabular}{|c|c|c|c|c|} \hline
        ...
        5分& １次関数の復習 & \begin{tabular}{l}1次関数のグラフを書\\いてみて， 関数とグ\\ラフの関係を思い出す．\end{tabular}&  & 正しくグラフが描けているか． \\ \hline
        10分 & 導入1 & \begin{tabular}{l}関数\(y=x^2\)について，\\配布した表とを用いて\\座標平面上に\(x\)が整数\\の点についてプロット\\し，黒板で班ごとに発表する．\end{tabular}& a & a \\ \hline
        10分 & 導入2 & \begin{tabular}{l}\(\frac12\)間隔で表を作成し，\\それを座標平面上にプ\\ロットし，繋げてみる．\end{tabular} & & \begin{tabular}{c}2乗の計算ができて， \(y\)軸に対称か，\\\(|x|\)に関して増加しているか．\end{tabular}\\ \hline
        15分 & 展開 & \begin{tabular}{l}\end{tabular}& &  \\ \hline
        5分 & まとめ & & & \\\hline
      \end{tabular}}
  \end{center}
